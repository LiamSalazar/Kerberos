...
set "AUTH_CP=auth-core\target\classes;auth-crypto\target\classes;auth-transport\target\classes;auth-storage-sqlite\target\classes;auth-as\target\classes;auth-tgs\target\classes;auth-service\target\classes;auth-client-sdk\target\classes;auth-websocket-gateway\target\classes;%AUTH_WS_DEPS%"
